...
for stock in stocks:
    df1=data.get_data_yahoo(stock,start="2000-1-1",end='2020-8-27')["Adj Close"].to_csv(f"prices_{stock}.csv")
    df2=data.get_data_yahoo(stock,start="2000-1-1",end='2020-8-27')["Volume"] .to_csv(f"volume_{stock}.csv")
